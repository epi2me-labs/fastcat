...
## [v0.24.1]
### Changed
- Pinned conda package to htslib >=1.20, <1.22 as the implications of CRAM 3.1 as a default are not clear.
### Removed
- `zenodo.json` file as it doesn't achieve the intended purpose of setting license metadata on Zenodo uploads.
...
## [v0.21.0]
### Added
- `fastcat` can now optionally output BAM files, carrying across meta information into tags.
